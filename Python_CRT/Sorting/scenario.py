'''
Design a backend system to manage multilayer game tournaments.Players register, play matches,and earn points. The system should rank them,
handle tiebrakers, and stimulate knockout rounds.
...
Tech Stack:
core python (list,dictionaries,tuples)
OOP(player,match,Tournament classes)
Recursion(knockout Stimulation)
