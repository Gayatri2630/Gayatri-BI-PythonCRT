'''
Scenario 1. Vignan Campus Rap
Context: Each building in a college campus is a node, and walkable paths 
are edges
...
-Find if there are any disconnected buildings (buildings net connected to campus).
'''
campus={
